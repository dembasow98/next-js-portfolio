    ...
    >
      <div className="container">
        ...
        <div className="row">
          ...
          <div className="col-sm-6 m-15px-tb">
            <div className="feature-box-01 media">
            <img className="theme-bg" src="/static/img/services/translator.png" alt="Demba Sow Full stack web developer" />
              <div className="feature-content media-body">
                ...
                <p>
                  ...
                  My goal is to facilitate clear communication and enhance customer satisfaction by leveraging my linguistic skills and cultural awareness.
                </p>
            </div>
          </div>
          <div className="col-sm-6 m-15px-tb">
            <div className="feature-box-01 media">
              {/* <i className="icon theme-bg icon-desktop" /> */}
              <img className="theme-bg" src="/static/img/services/language-teacher.png" alt="Demba Sow Machine Learning Developer" />
                <div className="feature-content media-body">
