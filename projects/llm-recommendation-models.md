...
![Traditional Recommendation](/static/img/portfolio/llm-recommendation-systems/traditional-recommendation.png)

2. **Hybrid Recommendation**: Combining multiple sources of information to make a more robust prediction.

![Hybrid Recommendation](/static/img/portfolio/llm-recommendation-systems/result-of-hybrid.png)

3. **LLM-based Recommendation**: Leveraging large language models to make context-aware and personalized recommendations.

![LLM-based Recommendation](/static/img/portfolio/llm-recommendation-systems/results-of-llm-recommendation.png)
